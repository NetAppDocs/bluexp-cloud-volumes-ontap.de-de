...
TIP: Sie können die mit Ihren Azure-Konten verbundenen Azure Marketplace-Abonnements auf der Seite „Einstellungen“ > „Anmeldeinformationen“ managen. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["Managen Sie Ihre Azure-Konten und -Abonnements"^]
