...
[role="lead"]
Sie können die heruntergeladene Datei „Disk.RAW“ von Google Cloud anhand der über den verfügbaren Inhalte der Digest-Datei überprüfen https://["NSS"^] OpenSSL verwenden.
