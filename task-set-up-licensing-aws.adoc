...
TIP: Sie können die mit Ihren AWS-Konten verbundenen AWS Marketplace-Abonnements über die Seite „Einstellungen“ > „Anmeldeinformationen“ managen. https://["Managen Sie Ihre AWS-Konten und -Abonnements"^]
