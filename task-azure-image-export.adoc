...
NOTE: Weitere Informationen zum Installieren der Azure-CLI finden Sie unter https://learn.microsoft.com/en-us/cli/azure/install-azure-cli["Azure-Dokumentation: Installieren von Azure CLI"^].
