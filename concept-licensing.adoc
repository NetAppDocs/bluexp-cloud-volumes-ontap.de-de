...
NOTE: Die Speicher- und Netzwerkauslastung wird in binären Gigabyte (GB) berechnet, wobei 1 GB 2^30 Byte beträgt. Diese Maßeinheit wird auch als Gibibyte (gib) bezeichnet. Ebenso ist 1 TB 2^40 Byte, d. h. 1024 GB.
...
* Für Azure: E4s_v3, E4ds_v4, DS4_v2, DS13_v2, E8s_v3, E8ds_v4, E4ds_v5 und E8ds_v5
