...
IMPORTANT: NetApp wird die Verfügbarkeit der Node-basierten Lizenzierung in Kürze beenden. Nach Ende der Verfügbarkeit müssen Node-basierte Lizenzen in kapazitätsbasierte Lizenzen konvertiert werden. Weitere Informationen finden Sie unter https://mysupport.netapp.com/info/communications/CPC-00589.html["Mitteilungen für Kunden: CPC-00589"^].
