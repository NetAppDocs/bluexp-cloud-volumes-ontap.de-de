...
Informationen darüber, was bei Ablauf oder Entfernung Ihrer Lizenz mit Ihren Cloud Volumes ONTAP-Daten geschieht, finden Sie unter https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/FAQs_on_Cloud_Volumes_ONTAP_license_expiry["Dieser Knowledge Base-Artikel (KB)"^].
