...
Cloud Volumes ONTAP wird in den meisten Microsoft Azure Regionen unterstützt. https://["Hier finden Sie die vollständige Liste der unterstützten Regionen"^].
...
https://["Unterstützte Konfigurationen für Cloud Volumes ONTAP in Azure"^]
...
https://["Storage-Grenzen für Cloud Volumes ONTAP in Azure"^]
...
Weitere Details zu den Anwendungsfällen für diese Festplatten finden Sie unter https://["Microsoft Azure-Dokumentation: Welche Festplattentypen sind in Azure verfügbar?"^].
