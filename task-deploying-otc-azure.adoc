...
+
** Sie sollten ein haben https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["Anschluss, der Ihrem Arbeitsbereich zugeordnet ist"^].
...
. Wenn Sie dazu aufgefordert werden, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["Einen Konnektor erstellen"^].
...
** https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["Erfahren Sie mehr über Backup und Recovery von BlueXP"^]
+
