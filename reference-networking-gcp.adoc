...
BlueXP weist Cloud Volumes ONTAP in GCP automatisch die erforderliche Anzahl privater IP-Adressen zu. Sie müssen sicherstellen, dass in Ihrem Netzwerk genügend private Adressen verfügbar sind.
...
* *HA-Paar* BlueXP weist 14 IP-Adressen einem HA-Paar zu:
+
...
** 2 NAS LIFs (e0a)
** 2 Cluster-logische Schnittstellen (e0a)
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-gcp.html["Zeigen Sie die Netzwerkanforderungen für den Connector an"^]
