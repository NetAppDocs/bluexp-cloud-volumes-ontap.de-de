...
Die neuesten und vollständigen Details zum unterstützten finden Sie in der AWS-Dokumentationlink:https://aws.amazon.com/about-aws/global-infrastructure/localzones/features/?nc=sn&loc=2["EC2-Instanztypen in lokalen Zonen"^].
