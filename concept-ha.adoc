...
Die aktuellsten und vollständigen Informationen zu denlink:https://aws.amazon.com/about-aws/global-infrastructure/localzones/features/?nc=sn&loc=2["AWS-Dokumentation: EC2-Instanztypen in lokalen Zonen"^] .
