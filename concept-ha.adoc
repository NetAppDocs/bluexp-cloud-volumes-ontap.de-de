...
link:https://aws.amazon.com/about-aws/global-infrastructure/localzones/features/?nc=sn&loc=2["In AWS finden Sie die neuesten und vollständigen Details zu unterstützten EC2-Instanztypen in lokalen Zonen"^].
