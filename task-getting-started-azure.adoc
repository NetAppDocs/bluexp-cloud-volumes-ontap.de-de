...
Wenn Sie keine haben https://["Stecker"^] Dennoch muss ein Kontoadministrator einen erstellen. https://["Erfahren Sie, wie Sie in Azure einen Connector erstellen"^]
...
* https://["Erstellen eines Connectors über den Azure Marketplace"^]
* https://["Installieren der Connector-Software auf einem Linux-Host"^]
* https://["Was BlueXP mit Berechtigungen macht"^]
