...
Die automatische kostenlose 30-Tage-Testlizenz für Pay-as-you-go-Abonnements auf dem Marketplace des Cloud-Providers ist nicht mehr in Cloud Volumes ONTAP verfügbar. Die Verrechnung für jede Art von Marketplace-Abonnement (PAYGO oder Jahresvertrag) wird ab der ersten Nutzung ohne einen kostenlosen Testzeitraum aktiviert.
