...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-managing-svms-azure.html["Erstellen Sie Daten-Serving-Storage VMs für Cloud Volumes ONTAP in Azure"^]
