...
Cloud Volumes ONTAP unterstützt ab Version 9.14.1 jetzt die folgenden VMs der Edv5 Serie mit gemeinsam genutzten verwalteten Datenträgern in einer einzelnen oder mehreren Verfügbarkeitszonen.
