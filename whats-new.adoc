...
Die ONTAP-Mindestversion, die für die Konfiguration von Flash Cache auf Azure erforderlich ist, ist 9.13.1 GA. Es können nur ONTAP 9.13.1 GA und neuere Versionen zur Implementierung von Flash Cache auf Cloud Volumes ONTAP Systemen für Azure verwendet werden.
