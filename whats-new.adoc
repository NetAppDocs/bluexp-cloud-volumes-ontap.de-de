...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-protecting-ransomware.html["Setzen Sie NetApp Ransomware-Schutzlösungen für Cloud Volumes ONTAP ein"]
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9151-relnotes/["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
=== Veraltete Edge Cache-Lizenzpakete

Kapazitätsbasierte Edge Cache-Lizenzierungspakete sind für zukünftige Cloud Volumes ONTAP Implementierungen nicht mehr verfügbar. Sie können jedoch die API verwenden, um diese Funktionalität in Anspruch zu nehmen.



=== Mindestversionsunterstützung für Flash Cache in Azure

Die Cloud Volumes ONTAP-Mindestversion, die für die Konfiguration von Flash Cache in Azure erforderlich ist, ist 9.13.1 GA. Sie können ONTAP 9.13.1 GA und höhere Versionen nur zur Bereitstellung von Flash Cache auf Cloud Volumes ONTAP Systemen in Azure verwenden.
...
=== Kostenlose Testversionen für Marketplace-Abonnements sind veraltet

Die automatische kostenlose 30-Tage-Testversion für Pay-as-you-go-Abonnements auf dem Marktplatz des Cloud-Providers wird in Cloud Volumes ONTAP nicht mehr verfügbar sein. Die Verrechnung für jede Art von Marketplace-Abonnement (PAYGO oder Jahresvertrag) wird ab der ersten Nutzung ohne einen kostenlosen Testzeitraum aktiviert.
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9150-relnotes/["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
NOTE: AWS Local Zones werden beim Einsatz von BlueXP im Standardmodus unterstützt. Derzeit werden AWS Lokale Zonen nicht unterstützt, wenn BlueXP im eingeschränkten Modus oder im privaten Modus verwendet wird.
...
Falls von Ihren Sicherheitsrichtlinien gefordert, können Sie Ihre EC2-Instanzen für die Verwendung von IMDSv2 konfigurieren. Anweisungen finden Sie unter https://docs.netapp.com/us-en/bluexp-setup-admin/task-require-imdsv2.html["BlueXP Installations- und Administrationsdokumentation für das Management vorhandener Connectors"^].
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9141-relnotes/["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9140-relnotes/["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9131-relnotes/["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
Weitere Informationen über ARP mit Cloud Volumes ONTAP finden Sie unter https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-protecting-ransomware.html#autonomous-ransomware-protection["Autonomer Schutz Durch Ransomware"^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9131-relnotes["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
Informationen zur regionalen Verfügbarkeit finden Sie im link:https://bluexp.netapp.com/cloud-volumes-global-regions["Karten für globale Regionen für Cloud Volumes ONTAP"^].
...
FlexGroup Volumes, die direkt über ONTAP System Manager oder die ONTAP CLI erstellt wurden, sind nun über die neu gestaltete Volume-Kachel in BlueXP  sichtbar. Ähnlich wie bei FlexVol Volumes bietet BlueXP über eine dedizierte Volume-Kachel detaillierte Informationen zu erstellten FlexGroup Volumes.
...
Die Region China Nord 3 wird jetzt für Single-Node-Implementierungen von Cloud Volumes ONTAP 9.12.1 GA und 9.13.0 GA in Azure unterstützt. In diesen Regionen werden nur Lizenzen unterstützt, die direkt von NetApp erworben werden (BYOL-Lizenzen).


NOTE: Neue Cloud Volumes ONTAP-Implementierungen in China werden nur in den allgemeinen 9.12.1 und in der allgemeinen 9.13.0/7-Veröffentlichung unterstützt. Sie können diese Versionen auf neuere Patches und Releases von Cloud Volumes ONTAP aktualisieren. Wenn Sie neuere Cloud Volumes ONTAP-Versionen in China-Regionen bereitstellen möchten, wenden Sie sich an den NetApp-Support.
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9130-relnotes["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-logging-in.html["Greifen Sie über den Connector auf die BlueXP Konsole zu"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9121-relnotes["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^]
...
https://docs.netapp.com/us-en/ontap/object-storage-management/index.html["ONTAP-Dokumentation: Erfahren Sie, wie Sie S3 Objekt-Storage-Services konfigurieren und managen"^]
...
Informationen zur Konfiguration und Verwendung von NDMP finden Sie im https://docs.netapp.com/us-en/ontap/ndmp/index.html["ONTAP-Dokumentation: NDMP-Konfiguration – Überblick"].
...
https://bluexp.netapp.com/cloud-volumes-global-regions["Hier finden Sie die vollständige Liste der unterstützten Regionen für Cloud Volumes ONTAP"^]
...
Die Registerkarte „K8s“ wurde in einer vorherigen Version veraltet und wurde jetzt entfernt.
...
https://bluexp.netapp.com/pricing["Informieren Sie sich über die Preisgestaltung für WORM Storage"^].
...
Die Daten werden auf Cloud Volumes ONTAP in Azure mithilfe eines von Microsoft gemanagten Schlüssels automatisch verschlüsselt https://learn.microsoft.com/en-us/azure/security/fundamentals/encryption-overview["Azure Storage Service Encryption"^]. Sie können nun jedoch Ihren eigenen, vom Kunden gemanagten Verschlüsselungsschlüssel verwenden, indem Sie die folgenden Schritte ausführen:
