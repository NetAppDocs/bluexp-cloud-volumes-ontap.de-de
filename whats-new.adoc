...
=== Mindestversionsunterstützung für Flash Cache auf Azure

Die Cloud Volumes ONTAP-Mindestversion, die für die Konfiguration von Flash Cache auf Azure erforderlich ist, ist 9.13.1 GA. Sie können ONTAP 9.13.1 GA und höhere Versionen nur zur Bereitstellung von Flash Cache auf Cloud Volumes ONTAP Systemen in Azure verwenden.
