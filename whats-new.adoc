...
Die auf dieser Seite beschriebenen Verbesserungen beziehen sich nur auf BlueXP-Funktionen, die das Management von Cloud Volumes ONTAP ermöglichen. Lesen Sie, was mit der Cloud Volumes ONTAP Software selbst neu ist, https://["Wechseln Sie zu den Versionshinweisen zu Cloud Volumes ONTAP"^]
...
https://["Erfahren Sie, wie Sie die verbrauchte Kapazität in Ihrem Konto anzeigen"^].
...
https://["Erfahren Sie mehr über die neuen Funktionen in dieser Version von Cloud Volumes ONTAP"^].
...
Weitere Informationen zu https://["Unterstützte Festplattengrößen in Azure"^].
...
https://["So verschlüsseln Sie Volumes mit NetApp Verschlüsselungslösungen"^].
...
* https://["Installieren Sie den Connector an einem Ort ohne Internetzugang"^]
* https://["Greifen Sie über den Connector auf die BlueXP Konsole zu"^]
* https://["Fügen Sie eine nicht zugewiesene Lizenz hinzu"^]
...
https://["Lesen Sie, wie Sie S3-Objekt-Storage-Services in ONTAP konfigurieren und managen"^]
...
Weitere Informationen zum Konfigurieren und Verwenden von NDMP finden Sie unter https://["NDMP-Konfiguration – Überblick"].
...
Weitere Informationen zu dieser neuen Funktion finden Sie unter https://["Cloud Volumes ONTAP einrichten, um einen vom Kunden gemanagten Schlüssel in Azure zu verwenden"].
...
+
https://["Erfahren Sie, wie Sie Lademethoden ändern können"].
...
* *Edge Cache*: Lizenzierung für https://["Cloud Volumes Edge Cache"^]


https://["Erfahren Sie mehr über diese Lizenzierungspakete"].
...
https://["Erfahren Sie mehr über die Unterstützung von Elastic Volumes in AWS"].
...
https://["Hier finden Sie die vollständige Liste der unterstützten Regionen für Cloud Volumes ONTAP"^]
...
https://["Erfahren Sie mehr über die erweiterte Ansicht"].
...
https://["Erfahren Sie mehr über den Support für Elastic Volumes"].
...
"ec2:ModifyVolume",
----
Stellen Sie sicher, dass Sie diese Berechtigungen für jeden Satz von AWS Zugangsdaten bereitstellen, den Sie BlueXP hinzugefügt haben. https://["Sehen Sie sich die neueste Connector-Richtlinie für AWS an"^].
...
https://["Erfahren Sie mehr über Azure Private Link Connections with Cloud Volumes ONTAP"].
...
* https://["Erfahren Sie mehr über Storage-VM-Limits in Google Cloud"^]
* https://["Lesen Sie, wie Sie in Google Cloud Daten-Serving-Storage-VMs für Cloud Volumes ONTAP erstellen"]
...
https://["Erfahren Sie mehr über das Management von Kubernetes-Daten in BlueXP"^]
...
https://["Weitere Informationen zur Lizenzierung"].
...
https://["Erfahren Sie, wie Sie die Storage-Klasse für Tiered Daten ändern"].
...
https://["Unterstützte Konfigurationen für Cloud Volumes ONTAP in Google Cloud anzeigen"^]
...
Sie können noch immer eine Verbindung zu System Manager herstellen, indem Sie die Cluster-Management-IP-Adresse in einem Webbrowser, der eine Verbindung mit dem Cloud Volumes ONTAP System hat, eingeben. https://["Weitere Informationen zum Herstellen einer Verbindung mit System Manager"].
...
https://["Informieren Sie sich über die Preisgestaltung für WORM Storage"^].
...
https://["Erfahren Sie, wie Sie Volumes auf einem bestimmten Aggregat erstellen"].
...
https://["Informieren Sie sich über die Lizenzierungsoptionen für Cloud Volumes ONTAP"].
...
https://["Erfahren Sie, wie Sie nicht zugewiesene knotenbasierte Lizenzen austauschen"].
...
Wechseln Sie zum https://["Versionshinweise zu Cloud Volumes ONTAP"^] Weitere Informationen zu unterstützten Konfigurationen
...
Die Daten werden auf Cloud Volumes ONTAP in Azure automatisch verschlüsselt https://["Azure Storage Service Encryption"^] Mit einem von Microsoft gemanagten Schlüssel Sie können nun jedoch Ihren eigenen, vom Kunden gemanagten Verschlüsselungsschlüssel verwenden, indem Sie die folgenden Schritte ausführen:
...
https://["Unterstützte Konfigurationen für Cloud Volumes ONTAP in AWS"^].
...
----
Stellen Sie sicher, dass Sie diese Berechtigungen für jeden Satz von Azure Zugangsdaten bereitstellen, den Sie BlueXP hinzugefügt haben. https://["Sehen Sie sich die neueste Connector-Richtlinie für Azure an"^].
...
https://["Zeigt unterstützte Konfigurationen für Cloud Volumes ONTAP in GCP an"^].
...
Wechseln Sie zum https://["AWS Marketplace Seite"^] Weitere Informationen zu Preisen finden Sie im https://["Versionshinweise zu Cloud Volumes ONTAP"^] Erfahren Sie mehr über diese Lizenzoption.
...
Beachten Sie, dass für einen Konnektor eine neue Berechtigung zum Löschen von Azure-Snapshots erforderlich ist. https://["Sehen Sie sich die neueste Connector-Richtlinie für Azure an"^].
...
Cloud Volumes ONTAP kann nun eine Ultra SSD als VNVRAM verwenden, wenn Sie den E32s_v3-VM-Typ mit einem Single-Node-System verwenden https://["In jeder unterstützten Azure-Region"^].
...
* https://["Erfahren Sie mehr über Azure Private Links"^]
* link:task-enabling-private-link.html["Erfahren Sie mehr über die Verwendung eines Azure Private Links mit Cloud Volumes ONTAP"]
