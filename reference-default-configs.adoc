...
* Bei HA-Paaren sind zwei st1-EBS-Volumes für die Mediator-Instanz, die ca. 8 gib und 4 gib betragen, sowie eine zusätzliche gp3-Festplatte mit 140 gib in jedem Node, die eine Kopie der Root-Daten des anderen Node enthalten soll.
+
